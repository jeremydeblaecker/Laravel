...
@section('content')
    ...
    @if ($errors->any())
        ...
        <div class="alert alert-danger">
            ...
            <strong>Whoops!</strong> Erreur(s)!?<br><br>
         ...
         <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="bio" value="{{ $user->bio }}" class="form-control" placeholder="Bio">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="email" value="{{ $user->email }}" class="form-control" placeholder="mail">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="admin" value="{{ $user->admin }}" class="form-control" placeholder="admin">
